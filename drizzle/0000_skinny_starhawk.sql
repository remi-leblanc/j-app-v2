...
ALTER TABLE "word_jlpt" ADD CONSTRAINT "word_jlpt_word_id_words_id_fk" FOREIGN KEY ("word_id") REFERENCES "public"."words"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "word_jlpt_level_idx" ON "word_jlpt" USING btree ("level");--> statement-breakpoint
...
CREATE INDEX "word_pos_category_idx" ON "word_pos" USING btree ("category");--> statement-breakpoint
